...
Route::group(array('prefix' => 'm', 'middleware' => ['mobile']), function(){
    ...
    // iteration-11 
	Route::get('talent-matcher', 'Mobile\MobileTalentController@mTalent_matcher')->name('mTalent_matcher');
...
Route::post('ajax/booking/MdeleteBooking',    'Mobile\MobileHomeController@MdeleteBooking')->name('MdeleteBooking');
