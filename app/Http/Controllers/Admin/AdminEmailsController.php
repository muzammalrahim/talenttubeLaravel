    ...
    function getDatatable(){
      ...
      ->addColumn('action', function ($records) {
        if (isAdmin()){
            ...
            $rhtml = '';
            $rhtml .= '<button id="itemdel" type="button" class="btn ml-4 px-2 btn-danger btn-sm BulkEmailConfirmEmail" data-id='.$records->id.' data-title="'.$records->title.'">Send Email</button>';
