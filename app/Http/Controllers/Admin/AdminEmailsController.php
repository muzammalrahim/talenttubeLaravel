    ...
    function getDatatable(){
      ...
      ->addColumn('action', function ($records) {
        if (isAdmin()){
            ...
            $rhtml = '';
            $rhtml .= '<button id="itemdel" type="button" class="btn mt-2 ml-4 px-2 btn-danger btn-sm BulkEmailConfirmEmail" data-id='.$records->id.' data-title="'.$records->title.'">Send Email</button>';
            $rhtml .= '<button id="itemdel" type="button" class="ml-4 px-1 mt-2 btn btn-danger btn-sm BulkEmailDeleteConfirmEmail" data-id='.$records->id.' data-title="'.$records->title.'">Delete Email</button>';
            return $rhtml;
        }
      })
