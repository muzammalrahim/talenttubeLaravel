      ...
      <div class="row b-filter-row top-filter-row d-flex">
         ...
         <div class="row">   
            <div class="col-md-6 col-sm-6">
               <div class="input-employee clearfix">
                  <div class="row">
                     ...
                     <label class="col-12 col-sm-3 browse-heading font-weight-normal">Keyword:</label>
            ...
            <div class="col-md-6 col-sm-6">
               <div class="input-employee clearfix">
                  <div class="row">
                     <label class="col-12 col-sm-3 browse-heading font-weight-normal">Salary:</label>
                     {{-- <input type="text" class="form-control col-md-8" name="filter_salary" aria-label="Recipient's username"> --}}
                     <select name="filter_salary" class="form-control col-12 col-sm-8 ml-3 bg-white icon_show" id="filter_salary" data-placeholder="Select Salary Range">
         ...
         <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
               <div class="input-employee clearfix">
                  ...
                  <div class="row">
                     <label class="col-12 col-sm-3 browse-heading font-weight-normal">Sort By:</label>

                     {{-- <div class="sortByFieldLabel col-5 pt-2">Sort By: </div> --}}
                     <select name="ja_filter_sortBy" class="form-control col-12 col-sm-8 ml-3 bg-white icon_show">
