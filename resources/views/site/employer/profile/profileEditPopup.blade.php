		...
		<div class="frame">
			...
			<div class="cont">
				<div class="bl_frm bl_frm_editor" style="height: auto; opacity: 1; transition: height 0.3s linear 0s, opacity 0.3s linear 0s;">
					<form id="frm_profile_edit_main" name="frm_profile_edit_main" method="post"> {{ csrf_field() }}
						...
						<table class="tb_frmX frm_edit_main">
							<tbody>
								<tr>
									...
									<td>
										<div class="field">
											<input id="profile_edit_main_nickname" class="inp nickname" name="nickname" type="text" value="{{$user->company}}" title="The username needs to be between 3 and 20 symbols in length.">
								...
								<tr>
									...
									<td>
										<div class="fieldX">
											<div id="profile_edit_main_orientation-styler"> {{(isTypeEmployer($user))?'Employer':'Job Seeker'}} </div>
										</div>
									</td>
								</tr> {{-- Location --}}
								<tr>
											...
											<div class="bl bl_location">
												<div class="location_filed mt10">
													<div class="location_input dtable w100">
														...
														<button type="button" id="location_search_load" class="btn btn-success location_search_btn w20 fl_left">Search</button> --}} </div>
													<div class="location_latlong dtable w100">
														...
														<input type="hidden" name="location_country" id="location_country" value=""> </div>
													<div class="location_map_box dtable w100">
														<div class="location_map" id="location_map"></div>
													</div>
												</div> <span id="location_city_error" class="error to_hide hide_it">Location City Field is Required</span> <span id="location_state_error" class="error to_hide hide_it">Location State Field is Required</span> <span id="location_country_error" class="error to_hide hide_it">Location Country Field is Required</span>
												<div class="cl"></div>
											</div>
										</div>
									</td>
								</tr> {{-- Location end --}} </tbody>
						</table>
					</form>
				</div>
