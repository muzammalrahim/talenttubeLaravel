                           ...
                           <td>
                              <div class="locationContainer">
                                 <div class="bl bl_location">
                                    ...
                                    <span id="location_city_error" class="error to_hide hide_it">Location City Field is Required</span> <span id="location_state_error" class="error to_hide hide_it">Location State Field is Required</span> <span id="location_country_error" class="error to_hide hide_it">Location Country Field is Required</span>
                                    <div class="cl"></div>
                                 </div>
                              </div>
                           </td>
