...
<div class="newJobCont">
   <div class="head icon_head_browse_matches">Mutual Users List</div>
   {{-- @dump($employers) --}}
            ...
            <div class="jobSeeker_box relative dinline_block w100">
               ...
               <div class="js_profile w_30p w_box dblock fl_left">
                  ...
                  <div class="js_info center">
                     <div class="js_name">
                        <h4 class="bold">{{$js->name}} {{$js->surname}}</h4>
                     </div>
         ...
         <div class="jobSeeker_row dblock js_{{$js->id}} mb20 p20">
            <div class="jobSeeker_box relative dinline_block w100">
               ...
               <div class="js_actionBtn">
                  <a class="jsUnBlockUserBtn graybtn jbtn" data-jsid="{{$js->id}}">UnLike</a>
               </div>
            </div>
         </div>
         --}}
