         ...
         <div class="row b-filter-row top-filter-row">
            <div class="row ">   
               <div class="col-md-6 col-sm-6">
                  <div class="input-employee clearfix">
                     ...
                     <div class="row">
                        <label class="col-12 col-sm-3 browse-heading">Keyword:</label>
               ...
               <div class="col-md-6 col-sm-6">
                  <div class="input-employee clearfix">
                     ...
                     <div class="row">
                        <label class="col-12 col-sm-3 browse-heading">Salary:</label>

                        {{-- <input type="text" class="form-control col-md-8" name="filter_salary" aria-label="Recipient's username"> --}}
                        <select name="filter_salary" class="form-control col-sm-8 col-12 ml-3 bg-white icon_show" id="filter_salary" data-placeholder="Select Salary Range">
               ...
               <div class="col-md-12">
                  <div class="row">
                     <div class="searchField_resume col-md-6">
                        ...
                        <div class="row pb-4">
                           <label class="col-12 col-sm-3 browse-heading">Resume:</label>
                     ...
                     <div class="searchField_resume col-md-6">
                        <div class="row">
                           <label class="col-12 col-sm-3 browse-heading">Age Group:</label>

                              <select name="filter_by_age_val" class="form-control col-12 col-sm-8 ml-3 bg-white icon_show" id="filterAgeGroup">
                  ...
                  <div class="row">
                     <div class="col-md-6 col-12">
                        <div class="row">
                           ...
                           <div class=" col-12 col-sm-9">
                              <select style="width: 94%" class="dinline_block filter_qualification_type js-select form-control icon_show bg-white" onchange="showQualificationSelect2()" name="filter_qualification_type" data-placeholder="Select Qalification & Trades">
                     ...
                     <div class="col-md-6 col-12">
                        <div class="row">
                           ...
                           <div class=" col-10 col-sm-8 filter_industryDiv">
                              <select name="filter_industry[]" multiple="multiple" id="filter_industry" placeholder = "Filter by Job" class="multi-select form-control custom-select" style="width: 93%">
                                 @php
               ...
               <div class="col-md-12">
                  <div class="row">
                     <div class="col-md-6 pb-4 pb-lg-none col-12">
                        <div class="row">
                           <label  class="col-12 col-sm-3 browse-heading">
                              User Tags:
                           </label>
                           ...
                           @if(!empty($tags))
                           <div class="filter_tagList col-10 col-sm-8">
                              <select name="filter_tags[]" multiple="multiple" id="filter_by_usertaga" placeholder = "Filter by Job" class="multi-select form-control custom-select" style="width: 93%">
                     ...
                     {{-- ============================================ Filter by Gender ============================================ --}}
                      <div class="col-md-6 col-12">
                        <div class="row">
                           <label class="col-12 col-sm-3 browse-heading">Gender:</label>
                              {{-- <input type="checkbox" name="filter_tags_status" class=""> --}}
                           <div class="col-2 col-sm-1 custom-checkbox mt-1">
                              <input type="checkbox" name="filter_by_gender" checked class="filter_by_gender">
                           </div>
                           {{-- @if(!empty($tags)) --}}
                           <div class="filter_gender_cont col-10 col-sm-8">
                              <select name="filter_by_gender_val" id="filterAgeGroup" placeholder = "Filter by Job" class="form-control icon_show bg-white" style="width: 93%;">
               ...
               <div class="col-md-12 browse-mp">
                  <div class="row">
                     ...
                     <div class="row b-filter-row">
                        <div class="col-md-6 col-12">
                           <div class="row">
                              <div class=" col-12 col-sm-3 mt-1 b-mob-pad">
                                 <h5 class="browse-heading">Questions:</h5>
                              </div>
                              <div class="col-2 col-sm-1 custom-checkbox mt-1">  
                              ...
                              <div class=" col-10 col-sm-8">
                                 <div class="input-employee clearfix filter_question_cont">
                                    ...
                                    <select type="text" class="form-control bg-white icon_show" name="filter_question" aria-label="Recipient's username" style="width: 97%;">
                        ...
                        <div class="col-12 col-md-6">
                           <div class="row">
                              <div class="col-2 col-sm-6 filter_question_cont ">
            ...
            <div class="row b-filter-row  mt-3">
               <div class="col-md-12 browse-mp">
                  ...
                  <div class="FilterLocationBox col-10 col-sm-8">
