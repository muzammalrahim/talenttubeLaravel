   ...
   <div class="job_applications_filter mb20 emp-t-row">
      ...
      <div class="row b-filter-row top-filter-row">
         ...
         <div class="searchField_keyword d-flex mb20 col-md-4">
            <div class="  col-5 pt-1">Filter by Keyword: </div>
            <input type="text" name="filter_keyword" class="form-control">
         </div>
         {{-- ============================================ Filter by Question ============================================ --}}
         <div class="searchField_questions mb20 col-md-8 d-flex">
            <div class="  col-2">Filter by Question: </div>
            <div class="filter_question_cont col-10 ml-2">
         ...
         <div class="searchField_resume {{-- dwebkitbox --}} mb20 col-md-4 d-flex">
            <div class="searchFieldLabel col-5 pt-1 ">Filter by Resume: </div>
            <input type="text" name="filter_by_resume_value" class="filter_by_resume_value form-control">
         </div>
         {{-- ============================================ Filter by Age Group ============================================ --}}
         <div class="searchField_resume {{-- dwebkitbox --}} mb20 col-md-4 d-flex">
            <div class="searchFieldLabel col-5 pt-2">Filter by Age Group: </div>
         ...
         <div class="searchField_industry mb20 col-md-4 d-flex">
            <div class="searchFieldLabel dinline_block col-5">Filter by Industry: </div>
         ...
         <div class="searchField_Age mb10 col-md-4 d-flex">
            <div class="searchFieldLabel  col-5 pt-2">Filter by Gender: </div>
