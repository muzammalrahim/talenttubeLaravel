            ...
            <div class="row ">   
               ...
               <div class="col-md-6 col-sm-6">
                  <div class="input-employee clearfix">
                     ...
                     <div class="row">
                        <label class="col-12 col-sm-3 browse-heading">Salary Range:</label>
               ...
               <div class="col-md-12">
                  <div class="row">
                     <div class="searchField_resume col-md-6">
                        ...
                        <div class="row pb-4">
                           <label class="col-12 col-sm-3 browse-heading">Filter by Resume:</label>
                     ...
                     <div class="searchField_resume col-md-6">
                        <div class="row">
                           <label class="col-12 col-sm-3 browse-heading">Filter by Age Group:</label>
                     ...
                     <div class="col-md-6 col-12">
                        <div class="row">
                           ...
                           <div class=" col-12 col-sm-9">
                              <select style="width: 94%" class="dinline_block filter_qualification_type js-select form-control" onchange="showQualificationSelect2()" name="filter_qualification_type" data-placeholder="Select Qalification & Trades">
               ...
               <div class="col-md-12">
                  <div class="row">
                     ...
                     {{-- ============================================ Filter by Gender ============================================ --}}
                      <div class="col-md-6 col-12">
                        <div class="row">
                           <label class="col-12 col-sm-3 browse-heading">Filter by User Gender:</label>
                              {{-- <input type="checkbox" name="filter_tags_status" class=""> --}}
                           <div class="col-2 col-sm-1 custom-checkbox mt-1">
                           ...
                           <div class="filter_gender_cont col-10 col-sm-8">
                              <select name="filter_by_gender_val" id="filterAgeGroup" placeholder = "Filter by Job" class="form-control" style="width: 93%;">
                           ...
                           <div class="row">
                              ...
                              <div class=" col-10 col-sm-8">
                                 <div class="input-employee clearfix filter_question_cont">
                                    ...
                                    <select type="text" class=" bg-white" name="filter_question" aria-label="Recipient's username" style="width: 97%;">
