...
<div class="container py-3">
	<div class="initialQuestions">
		...
		<div class="row123"><b class="">{{$crossreference->userName}}</b> has provided your name as referee and <span class="font-weight-bold"> Talenttube </span> helps you complete the referencing process quickly and securely online. </div>
	...
	<div class="workreference d-none">
	    ...
	    <form method="POST" name="newRerenceForm" class="newRerenceForm newJob job_validation">
		   ...
		   <h5 class="font-weight-bold text-center"> Verification Detail </h5>
			  ...
			  <div class="form-group">
			    <label for="inputDates">Roughly, how long ago did you first meet the candidate (approximate dates are sufficient)?</label>
