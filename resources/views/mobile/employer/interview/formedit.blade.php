               ...
               <div class="slots text-left">
                  ...
                  <div class=" slot s{{$key+1}}  col-md-5 borderline m_rb20">
                     ...
                     <div class="row  slotRowMargin">
                        <div class="col-2 slotFontSize mt-1">
                           <p>
                              Time
                           </p>
                        </div>
                        <div  class="col-4 "><input class="form-control form-control-sm timepicker timepicker-without-dropdown slotFontSize" type="text" value="{{$slot->starttime}}"  name="slot[{{$key+1}}][start]"  twelvehour="true" value="slot[{{$key+1}}]" required /></div>
                        <div  class="col-2 mt-1 slotFontSize textCen">
                           <p>
                              To
                           </p>
                        </div>
                        <div  class="col-4"><input class="form-control form-control-sm timepicker  timepicker-without-dropdown slotFontSize" type="text" value="{{$slot->endtime}}"  name="slot[{{$key+1}}][end]" required />
                        </div>
                     </div>
                     <div class="row slotRowMargin">
                        <div class="col-2 slotFontSize mt-1">
                        ...
                        <div class="col-10 "><input type="date" value="{{Carbon\Carbon::parse($slot->date)->format('Y-m-d')}}" name="date[{{$key+1}}]" class="form-control form-control-sm  slotFontSize "></div>
                     </div>
                     <div class="row slotRowMargin">
                        <div class="col-9 slotFontSize mt-1">
                           <p>  Maximum number of interview:</p>
                        </div>
                        <div class="col-3 mt-1"> {{ Form::select('salary', getMaximumInterviews(), $slot->maximumnumberofinterviewees, ['name' => 'maximumnumber['.($key+1).']', 'class' => 'sc']) }}
                        </div>
                     </div>
                  </div>
                  @endforeach
