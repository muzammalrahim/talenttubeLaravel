            ...
            <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="location_latlong dtable w100 hide_it">
                                ...
                                <input type="hidden" name="geo_cities" id="location_city"  value="1">
                                <input type="hidden" name="geo_states" id="location_state"  value="1">
                                <input type="hidden" name="geo_country" id="location_country"  value="1">
                                </div>
