...
{{-- ============================================ Card Body ============================================ --}}
        ...
        <div class="card-body jobAppBody pt-2">
                 ...
                 <form method="POST" name="edit_job_form" class="edit_job_form newJob job_validation">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="title" value="{{$job->title}}" class="form-control" id="title">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                  <textarea class="form-control z-depth-1" name="description" id="description" rows="3" placeholder="Write something here...">{{$job->description}}</textarea>
            ...
            <div class="form-group">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" name="vacancies" value="{{$job->vacancies}}" class="form-control" id="Vacancies ">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        @endphp
                                <input placeholder="Selected date" name="expiration" type="text" value="{{$expiration}}" id="datepicker" class="form-control datepicker">
                                        ...
                                        <div class="option form-group">
                                                    ...
                                                    @endif
                                                            <div class="col-sm-3 custom-control custom-checkbox custom-control-inline mt-2">
                                                                    ...
                                                                    <label class="custom-control-label font-weight-bold" for="jq[{{$keyq}}][option][{{$key}}][preffer]">Undiserable</label>
                                                            </div>
...
{{-- ============================================ Card Footer ============================================ --}}
            ...
            <div class="card-footer text-muted jobAppFooter p-1">
                    ...
                    <div class="text-center">
                        ...
                        <a class="jobApplyBtn graybtn jbtn btn btn-sm btn-success mr-0 updateJobBtn">Save</a>
   ...
   $(document).on('click','.removeJobQuestion',function(){
    ...
    $('.updateJobBtn').on('click',function() {
       ...
       // $('.updateJobBtn').html(getLoader('pp_profile_edit_main_loader')).prop('disabled',true);
        ...
        $.ajax({
            type: 'POST',
            url: base_url+'/m/ajax/mjob/{{$job->id}}',
            data: formData,
