...
<form method="POST" name="job_apply_form" id="MobileJobApplyForm" class="job_apply_form jobApply jobApply_validation">
    ...
    <div class="applyJobFormField mb-3">
        <textarea type="text" id="form79textarea" class="md-textarea form-control" rows="3" placeholder="Answer"></textarea>
    </div>
