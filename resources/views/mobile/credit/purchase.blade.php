...
<div class="newJobCont">
    <div class="head icon_head_browse_matches jobInfoFont text-center mb-2">Purchase Credits</div>

    <div class="cont cont_boost_plan" style="display: block;">

        <div class="row credit_wallet m-0">
...
{{--                 <input type="radio" value="1" name="amount" class="radioClick"> 100 credits for $1.00<br>
                ...
                <input type="submit" class ="btn btn-sm btn-primary" name="Purchase" />
        </form>
