    ...
    <div class="card-body">
        <div class="row">
            ...
            {{-- @foreach ($applications as $app)
                    ...
                    {{ $app->jobseekerMale }}<br>

            @endforeach --}}


            <div class="col-4">
                <div class="card-header font-weight-bold"> Applicants</div>
                
                <div class="row">
                    <div class="col-9">Total Males </div>
                    <div class="col-3">{{ $males}} </div>
                    <div class="col-9">Total Females </div>
                    <div class="col-3">{{ $females}} </div>
                </div>
                {{-- Total Males : {{ $males}} <br> --}}
                {{-- Total Females : {{ $females}} <br> --}}
            ...
            <div class="col-4">
                ...
                @foreach ($indus as $ind)
                    @if ($ind != 0)
                        {{-- expr --}}
                        <div class="row">
                            <div class="col-9"> {{ $industriesnew[$loop->index] }} </div>
            ...
            <div class="col-4">
                <div class="card-header font-weight-bold"> Applicants who went unsuccessfull </div>
                
                <div class="row">
                    <div class="col-9">Previous Status</div>
                    <div class="col-3">Count</div>
                </div>
                
                @foreach ($JobsApplication as $app)
                    <div class="row">
                        <div class="col-9">{{ $app->prev_status }}</div>
                        <div class="col-3">{{ $app->statu_count }}</div>
                    </div>
