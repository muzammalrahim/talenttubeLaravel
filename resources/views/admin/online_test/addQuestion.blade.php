<div class="form-group row">
    ...
    <input type="hidden" name="" class="summernoteId" value="{{$qId}}">

    <span class="removeQuestion btn btn-danger col-md-1 h-25"><i class="fa fa-trash"> </i></span>
...
<script>
  $(document).ready(function() {
      var qid = $('.summernoteId').val();

      console.log('AddQuestion Blade File'+ qid);
      $('#summernote_'+qid).summernote();
  });
</script>