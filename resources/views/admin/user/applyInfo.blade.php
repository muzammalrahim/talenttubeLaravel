...
<form name="job_apply_form" id="job_apply_form" class="job_apply_form jobApply jobApply_validation">
    ...
    <div class="applyJobFormField mb-3">
        ...
        <a type="button" class="submitApplication btn btn-primary waves-effect waves-light modelConfirmAction">Submit
