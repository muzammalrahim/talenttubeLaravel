...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5"><h4 class="card-title mb-0">{{ __('Employer Management.') }}</h4></div>
            </div>
            <hr>
            ...
            <div class="card card-primary card-tabs">
                      ...
                      <div class="card-header p-0 pt-1" style="background: #6c757d;">
                        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                          ...
                          <li class="nav-item col-lg-3">
                            <a class="nav-link" id="custom-tabs-one-profile-tab" data-toggle="pill" href="#custom-tabs-one-profile" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false"><b>Employer Information</b></a>
                          </li>
                          <li class="nav-item col-lg-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                  ...
                                  @include('admin.employer.tabs.tab1')
                                  @include('admin.employer.tabs.tab2')
                                  @include('admin.employer.tabs.tab3')
                                  @include('admin.employer.tabs.tab4')
