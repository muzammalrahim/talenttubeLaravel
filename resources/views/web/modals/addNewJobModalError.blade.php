<div class="modal fade" id="addNewJobModalError" role="dialog">
    <div class="modal-dialog delete-applications">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h1 class="modal-title"><i class="fas fa-thumbs-down trash-icon"></i> Note </h1>
        </div>
        <div class="modal-body">
          {{-- <strong>Are you sure you wish to continue?</strong> --}}
          <p> Your job can not be posted until you complete all fields </p>
        ...
        <div class="dual-footer-btn">
          ...
          <button type="button" class="orange_btn" data-dismiss="modal"><i class="fa fa-check"></i>OK</button>
        </div>
      </div>
