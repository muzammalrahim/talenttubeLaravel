    ...
    <div class="modal-dialog delete-applications">
      ...
      <div class="modal-content border-0">
        <div class="modal-header">
          ...
          <h1 class="modal-title m-auto"><i class="fas fa-ban trash-icon"></i>UnBlock User</h1> 
        </div>
        ...
        <div class="dual-footer-btn mx-3 mx-md-0">
          ...
          <button type="button" class="orange_btn float-none" onclick="confirmUnBlockEmployer()" data-dismiss="modal"><i class="fa fa-check"></i>OK</button>
        </div>
      </div>
    </div>
</div>